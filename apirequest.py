...
# 定义 curl 命令
curl_command1 = 'curl -X POST "http://127.0.0.1:8000" -H \'Content-Type: application/json\' -d \'{"prompt": "你好", "history": []}\''
#curl_command1 = 'curl -X POST "http://localhost:8000/" -H \'Content-Type: application/json\' -d \'{"prompt": "hi", "history": []}\''
#curl_command2 = 'curl -X POST "http://localhost:8001/" -H \'Content-Type: application/json\' -d \'{"prompt": "hi", "history": []}\''

curl_command2 = 'curl -X POST "http://127.0.0.1:8001" -H \'Content-Type: application/json\' -d \'{"prompt": "hello", "history": []}\''
